...
import com.dankanq.rickandmorty.databinding.FragmentCharacterListBinding
import com.dankanq.rickandmorty.presentation.character.detail.CharacterFragment
import com.dankanq.rickandmorty.presentation.character.main.FilterCharacterListFragment.Companion.BUNDLE_GENDER_KEY
import com.dankanq.rickandmorty.presentation.character.main.FilterCharacterListFragment.Companion.BUNDLE_NAME_KEY
import com.dankanq.rickandmorty.presentation.character.main.FilterCharacterListFragment.Companion.BUNDLE_SPECIES_KEY
import com.dankanq.rickandmorty.presentation.character.main.FilterCharacterListFragment.Companion.BUNDLE_STATUS_KEY
import com.dankanq.rickandmorty.presentation.character.main.FilterCharacterListFragment.Companion.BUNDLE_TYPE_KEY
import com.dankanq.rickandmorty.presentation.character.main.FilterCharacterListFragment.Companion.SEARCH_CHARACTERS_RESULT_KEY
import com.dankanq.rickandmorty.utils.presentation.adapter.CharacterListAdapter
...
class CharacterListFragment : Fragment() {
    ...
    private fun setupAppBarLayout() {
        with(binding.layoutAppBar) {
            etSearch.apply {
                ...
                hint = getString(R.string.search_characters)
            }
    ...
    private fun searchCharacters() {
        ...
        viewModel.applyFilters(
            params = CharacterListViewModel.CharacterFilterParams(
                name = name
            )
        )
    ...
    private fun setupFilterButton() {
        binding.fabFilter.setOnClickListener {
            FilterCharacterListFragment().show(
                requireActivity().supportFragmentManager,
                FilterCharacterListFragment.TAG
            )
        }
    }
    ...
    private fun setupFilterFragmentResultListener() {
        setFragmentResultListener(SEARCH_CHARACTERS_RESULT_KEY) { _, bundle ->
            ...
            val characterFilterParams = CharacterListViewModel.CharacterFilterParams(
                name = name,
                status = status,
                species = species,
                type = type,
            ...
            viewModel.applyFilters(characterFilterParams)
        }
    }
    ...
    private fun getRefreshLoadStateFlow(adapter: CharacterListAdapter): Flow<LoadState> {
